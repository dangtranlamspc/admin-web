...
import {getCategories, createCategory, updateCategory, deleteCategory } from "../../api/tintuc/categoryTinTucApi"

const CategoryTinTucPage: React.FC = () => {
...
export default CategoryTinTucPage;
