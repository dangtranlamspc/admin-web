...
import {getCategory, updateCategory, deleteCategory, createCategory} from "../../api/ctgd/categoryCTGDApi"

const CategoryCTGDPage: React.FC = () => {
...
export default CategoryCTGDPage;
