...
import { getProducts, createProduct, updateProduct, deleteProduct, getProductById, getCategories } from "../../api/ctgd/ctgdApi"

import type { UploadFile } from "antd/es/upload/interface";



interface CategoryCTGD {
    _id: string;
    name: string;
}
...
interface Product {
    ...
    isActive?: boolean;
    isMoi?: boolean;
    categoryctgd?: CategoryCTGD | string;
    images?: ProductImage[];
    createdAt?: string;
...
const ProductCTGDAdmin: React.FC = () => {
    ...
    //         category: typeof p.categoryctgd === "string" ? p.categoryctgd : (p.categoryctgd?._id ?? ""),
    //     });
    ...
    const handleSave = async (values: any) => {
        try {
            ...
            if (!editingProduct) {
                ...
                formData.append("categoryctgd", values.categoryctgd ?? "");
                ...
                if (newFiles.length > 0 || oldImages.length !== (editingProduct.images?.length ?? 0)) {
                    ...
                    const updateData: ProductUpdateData = {
                        ...
                        categoryctgd: values.categoryctgd ?? "",
    ...
    const handleEdit = (record: Product) => {
        ...
        form.setFieldsValue({
            name: record.name,
            categoryctgd: typeof record.categoryctgd === "string" ? record.categoryctgd : (record.categoryctgd?._id ?? ""),
    ...
    const columns = [
        ...
        { title: "Danh mục", dataIndex: ["categoryctgd", "name"] },
        {
            title: "Ngày tạo",
            dataIndex: "createdAt",
        ...
        <div style={{ padding: 20 }}>
            ...
            >
                <Form layout="vertical" form={form} onFinish={handleSave}>
                    ...
                    <Form.Item name="categoryctgd" label="Danh mục" rules={[{ required: true, message: 'Hãy chọn danh mục' }]}>
            ...
            >
                {viewingProduct ? (
                    <Descriptions bordered column={1}>
                        ...
                        /></Descriptions.Item>
                        <Descriptions.Item label="Danh mục">{(viewingProduct.categoryctgd && typeof viewingProduct.categoryctgd === "object") ? viewingProduct.categoryctgd.name : viewingProduct.categoryctgd ?? "-"}</Descriptions.Item>
...
export default ProductCTGDAdmin;